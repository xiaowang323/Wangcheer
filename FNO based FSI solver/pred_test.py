...
path = 'pred/pred10/'
dataloader = MatReader(path + 'true6.mat')
dataloader2 = MatReader(path + 'ns_fourier_3d_rnn_V500_T10_N400_ep200_m12_w646.mat')
u_data = dataloader.read_field('test_u')[j, :, :, :, :, :]
predx = dataloader2.read_field('pred')[j, :, :, :, :, :]
